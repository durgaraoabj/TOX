...
$(function () {
    function drawCircle(element) {
        var elementCtx = element.getContext("2d"), previousFillStyle = elementCtx.fillStyle;
    ...
    $("#split-button-circle").igSplitButton({
        ...
        click: function (event, ui) {
            var elementToChangeId = event.target.id.split("-")[2];
    ...
    $("#split-button-triangle").igSplitButton({
        ...
        swapDefaultEnabled: true,
        click: function (event, ui) {
            var elementToChangeId = event.target.id.split("_")[0].split("-")[2];
            var shape = event.target.firstChild.id.split("_")[1];
            changeShape(elementToChangeId, shape);
        }
    });
    ...
    $("#color-picker-square").igColorPickerSplitButton({
        ...
        defaultColor: "#E36C09",
        colorSelected: function (event, color) {
            var triangleCanvas = document.getElementById("square");
            var squareCtx = triangleCanvas.getContext("2d");
