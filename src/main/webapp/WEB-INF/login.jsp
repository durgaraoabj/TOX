...
<body  background="<c:url value="/static/images/new-hope_1920x720_v2.jpg"/>" style="background-size: cover;min-height: 0px;">
	<div class="login-box" style="margin-left: 35%; margin-top: 10%">
  
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body" >
      <h5><p class="login-box-msg"><b>NEO TOX</b></p></h5>
