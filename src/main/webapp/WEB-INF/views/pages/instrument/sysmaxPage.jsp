...
<title>Sysmax Data</title>
</head>
<body>
	<div style="text-align: center; font-size: large; color: blue; font-weight: bold;">Sysmax Data</div>
<div class="card">
...
<script type="text/javascript">
	...
	function submitForm(){
		...
		if(studyidFlag){
			...
			var result = asynchronousAjaxCall(mainUrl+"/instrument/sysmaxStudyData/"+studyId);
