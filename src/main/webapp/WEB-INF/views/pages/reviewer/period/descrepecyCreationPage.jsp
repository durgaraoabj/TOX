...
<body>
	...
	<table class="table table-bordered table-striped">
		<tr>
			<th>Study No</th>
			<td>${scd.studyAccAnimal.study.studyNo }</td>
			<tH>Animal No</th>
			<td>${data.studyAccAnimal.animal.animalNo  }</td>
	...
	<table class="table table-bordered table-striped">
		<tr>
			<td colspan="10">Created Discrepancy's</td>
		</tr>
		<tr>
			<th>Date</th>
			<th>Created By</th>
	...
	<c:if test="${createDiscrepency}">
		...
		<input type="hidden" name="crfId" id="dataId" value="${data.id }">
		<input type="hidden" name="dataId" id="dataId" value="${data.id }">
		<table class="table table-bordered table-striped">
			<tr>
				<th>User name</th>
			...
			<tr>
				...
				<td colspan="2"><input type="button"
					class="btn btn-warning btn-sm" onclick="saveDisc()" value="Save" />
				</td>
			</tr>
		</table>
	</c:if>
