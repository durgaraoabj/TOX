...
<body>
	...
	<div class="card">
		<div class="card-header">
			<h3 class="card-title">CFR Observation Review List</h3>
		</div>
		 <div class="box-body">
			...
			<tr><th colspan="3">Observation Name</th></tr>
					<c:forEach items="${sgaindcListData}" var="obs">
						<tr>
							...
							<td>
							<input type="button" id="crfDataEntry" value="IN REVIEW" onclick="crfDataReviewView('${subjectgroupnid}', '${obs.crf.id}')"
 		...
 		<c:url value="/studyReview/allAnimalCrfDataReviewView" var="dataEntryUrl" />		 
