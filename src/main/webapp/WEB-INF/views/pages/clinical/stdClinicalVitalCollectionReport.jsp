...
<div class="card">
	<div class="card-header">
		<h3 class="card-title">Vital Collection Report</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
...
function submitForm(){
	...
	if(periodId != -1){
		...
		var result = asynchronousAjaxCall(mainUrl+"/study/clinical/stdClinicalVitalCollectionReportTable/"+periodId+"/"+subject);
