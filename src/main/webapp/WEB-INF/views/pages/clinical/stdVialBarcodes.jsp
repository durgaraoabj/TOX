...
<c:url value="/study/clinical/stdVialrBarcodePrint" var="stdVialrBarcodePrint" />
<sf:form action="${stdVialrBarcodePrint}" method="POST"  id="formsumit" >
<input type="hidden" name="type" id="type"/>
<div class="card">
	<div class="card-header">
		<h3 class="card-title">Vial Bar-codes</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
