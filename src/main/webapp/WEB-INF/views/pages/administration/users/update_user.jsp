        ...
        <form:form action="${createEmployeeUrl}" method="post" modelAttribute="employeeMaster" id="employeeFormId">
            ...
            <table class="table table-bordered table-striped">
				...
				<tr>
					...
					<td>Role</td>
					<td>
						<form:select id="roleId" path="role.id" class="form-control input-sm">
							<form:option value="0"  label="---Select---"/>
							<form:options items="${roles}" itemValue="id" itemLabel="roleDesc"/>
						</form:select>
						<span id="roleIdMsg" style="color: red"></span>
					</td>
				</tr>
			</table>
           	<table class="table table-bordered table-striped">
