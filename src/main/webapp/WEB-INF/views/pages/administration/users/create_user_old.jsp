...
<body>
    ...
    <div>
    	...
    	<c:url value="/administration/employee/createEmployee" var="createEmployeeUrl" />
        <form:form action="${createEmployeeUrl}" method="post" modelAttribute="employeeMaster" id="employeeFormId">
            ...
            <table class="table table-bordered table-striped">
				...
				<tr>
					<td>User ID</td>
					<td>
						<form:input path="empId" type="text" class="form-control input-sm" id="empId" onblur="checkempid(this.value)"/>
           	...
           	<table class="table table-bordered table-striped">
				...
				<tr>
					<td>First Name</td>
					<td><form:input path="firstName" type="text" class="form-control input-sm" /></td>
					<td>Middle Name</td>
					<td><form:input path="middleName" type="text" class="form-control input-sm" /></td>
					<td>Last Name</td>
					<td><form:input path="lastName" type="text" class="form-control input-sm" /></td>
				</tr>
				<tr>
					<td>Birth Date</td>
			...
			<c:if test="${userRole ne 'Study Director' and userRole ne 'Monitor'}">
				<div style="text-align:center"><input type="button" value="Create Employee" id="formSubmitBtn" 
