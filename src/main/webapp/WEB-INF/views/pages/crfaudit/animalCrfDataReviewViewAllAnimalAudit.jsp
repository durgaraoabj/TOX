	...
	<body>
		...
		<div class="card">
            <div class="card-header">
              <h3 class="card-title">Crf Audit :</h3>
            	...
            	<div style="width: 100%; overflow: scroll">
		        	...
		        	<table class="table table-bordered table-striped" id="example2">
						<tr>
							<%-- <th>Count 
								<c:choose>
									<c:when test="${data.allowDataEntry}"><input type="checkbox" name="descElementAll" value="${data.totoalDescNotDone}" 
								id="descall" onchange="selectAll()"/>All</c:when>
									<c:otherwise>
										${data.message}
									</c:otherwise>
								</c:choose>
