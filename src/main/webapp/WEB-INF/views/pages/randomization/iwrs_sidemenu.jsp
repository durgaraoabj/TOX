...
<%-- 					</c:if> --%>
					<li class="nav-item">
						<a href='<c:url value="/randomization/ipRequest"/>'
						class="nav-link"> <i class="nav-icon fas fa-th"></i>
							<p>IP Request<span class="right badge badge-danger">New</span></p>
					</a></li>
					<li class="nav-item">
						<a href='<c:url value="/randomization/ipResponse"/>'
						class="nav-link"> <i class="nav-icon fas fa-th"></i>
							<p>IP Response<span class="right badge badge-danger">New</span></p>
					</a></li>
					<c:if test="${siteName eq null or siteName eq ''}">
						<li class="nav-item">
							<a href='<c:url value="/randomization/allocation"/>'
							class="nav-link"> <i class="nav-icon fas fa-th"></i>
								<p>Allocation<span class="right badge badge-danger">New</span></p>
						</a></li>
					</c:if>
				</ul>
			</nav>
