...
<%@ taglib prefix="sf" uri="http://www.springframework.org/tags/form"%>
	<h5>Crf Privew</h5>
		...
		<table>
			<tr>
				<th>Type : </th><th>${crfviewTest.type}</th>
				<th>Sub Type : </th><th>${crfviewTest.type}</th>
			</tr>
			<tr>
				<th>Prefix : </th><th>${crfviewTest.prefix}</th>
				<th>Observation Name : </th><th>${crfviewTest.observationName}</th>
			</tr>
			<tr>
				<th>Observation Desc : </th><th>${crfviewTest.observationDesc}</th>
				<th>From : </th><th>${crfviewTest.configurationFor}</th>
			</tr>
			<tr>
				<th colspan="2">Access Roles : </th>
				<th> <c:forEach items="${roleMasters}" var="role">
				    		${role.role}&nbsp;
				    	</c:forEach>	
				</th>
			</tr>
...
<%-- 																					</c:forEach> --%>
		...
		<br/>
		<c:url value="/admini/crf/crfuploadsave" var="crfuploadsaveUrl" />		
