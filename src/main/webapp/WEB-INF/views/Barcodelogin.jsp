...
<body  background="<c:url value="/static/admintltcss/dist/img/loginimage.jpg"/>" style="background-size: 100%;">
	<div class="login-box" style="margin-left: 30%; margin-top: 20%">
  
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body" >
      <h5><p class="login-box-msg"><b>CLIANCE</b></p></h5>
