...
<%--   <link rel="stylesheet" href='<c:url value="/static/admintltcss/plugins/daterangepicker/daterangepicker.css"/>'> --%>
  ...
  <link rel="stylesheet" href='<c:url value="/static/fontawesome/css/all.min.css"/>'></link>
  <!-- Google Font: Source Sans Pro -->
  <link rel="stylesheet" href='<c:url value="/static/https/css/fonts.googleapis.com.css"/>'>
<!--   <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet"> -->
  <%-- <link rel="icon" href ="<c:url value="/static/images/NeoLogoLockups_NeoLogoWithoutTagline.png"/>"  type = "image/png"> --%>
   <!-- Date Picker Theam -->
...
<link rel="stylesheet" type="text/css" href='<c:url value="/static/defaultcss/main.css"/>'>
<!--   clock links -->
