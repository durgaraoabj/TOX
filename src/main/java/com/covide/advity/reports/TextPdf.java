...
public class TextPdf extends PdfPageEventHelper{
	
	@SuppressWarnings("unused")
	public void generateTextPdf(HttpServletRequest request, HttpServletResponse response) {
		try {
    		...
    		cell = new PdfPCell(new Phrase("PDF Document Generation Failed. Due to Some Internal Issue. Please Check And Try Again.", red));
