...
public class GenerateAnnotatePdf extends PdfPageEventHelper{

	public void genrerateAnnotatePdf(HttpServletResponse response, HttpServletRequest request, Crf crf,
			...
			// PdfWriter.getInstance(document, out);
		     ...
		     for(CrfSection sec : secList) {
		    	 if(!sec.getHedding().equals("")) {
		    		 ...
		    		 //Itemname
		    		 PdfPTable hstable2 = new PdfPTable(10);
		    		 hstable2.setWidthPercentage(95);
		    		 cell = new PdfPCell(new Phrase(sec.getName(), regular));
		    		 cell.setBorderColor(BaseColor.RED);
		    		 cell.setColspan(2);
		    		 hstable2.addCell(cell);
		    		 
		    		 cell = new PdfPCell(new Phrase("", regular));
		    		 cell.setBorder(Rectangle.NO_BORDER);
		    		 cell.setColspan(8);
		    		 hstable2.addCell(cell);
		    		 document.add(hstable2);
		    	 ...
		    	 if(sec.getGroup() == null || sec.getGroup().equals("")) {
		    		 //section elements
		    			...
		    			for(int k=1; k<=map.size(); k++) {
			    				...
			    				PdfPTable totaldec2 = new PdfPTable(mapList.size());
			    				    ...
			    				    if(scse != null) {
			    				    	if(!scse.getTopDesc().equals("")) {
			    							...
			    							// topdesc.setWidthPercentage(95);
			    							 ...
			    							 //ItemName
			    							 PdfPTable topdesc2 = new PdfPTable(10);
			    							 cell = new PdfPCell(new Phrase(scse.getName(), regular));
			    							 cell.setBorderColor(BaseColor.RED);
			    							 cell.setColspan(2);
			    							 topdesc2.addCell(cell);
					    					...
					    					document.add(space);
			    				    		 ...
			    				    		 if(!scse.getLeftDesc().equals("") && scse.getRigtDesc().equals("")) {
			    				    			...
			    				    			if(lstr.contains("&nbsp;")) {
						    					 ...
						    					 Phrase data = null;
						    					 String value ="";
						    					 data = new Phrase("", regular);
						    					 //Commented By DR Data Not Required
						    					 /*if(vpc != null) {
						    					 ...
						    					 //ItemName
						    					 PdfPTable desc2 = new PdfPTable(5);
						    					 desc2.setWidthPercentage(95);
						    					 ...
						    					 //For ItemNames
						    					 cell = new PdfPCell(desc2);
						    					 cell.setBorder(Rectangle.NO_BORDER);
						    					 totaldec2.addCell(cell);
						    					 document.add(totaldec2);
							    					...
							    					/* if(vpc != null) {
							    					 ...
							    					 PdfPTable desc2 = new PdfPTable(4);
							    					 data = new Phrase(value, regular);
							    					 //Commented By Dr Data Not Required
							    					 /*if(vpc != null) {
							    						 	value = crfDAO.studyCrfSectionElementData(vpc, scse);
 ...
 //itemNames
			    				    		...
			    				    		//Space purpose 
			    				    		 ...
			    				    		 if(!scse.getLeftDesc().equals("") && scse.getRigtDesc().equals("")) {
						    					...
						    					// desc.setWidthPercentage(80);
						    					 ...
						    					 //ItemNames
						    					 PdfPTable desc2 = new PdfPTable(2);
						    					 data = new Phrase(value, regular);
						    					 //Commented By Dr Data Not Required
						    					 /*if(vpc != null) {
						    						 value = crfDAO.studyCrfSectionElementData(vpc, scse);
			    				    		...
			    				    		if(!scse.getLeftDesc().equals("") && !scse.getRigtDesc().equals("")) {
			    				    		...
			    				    		}else if(!scse.getLeftDesc().trim().equals("") && scse.getRigtDesc().trim().equals("")){
			    				    			PdfPTable radtab  = null;
			    				    			PdfPTable radtab2  = null;
			    				    			String leftdesc = scse.getLeftDesc();
			    				    			String[] lefTemp = null;
			    				    		 ...
			    				    		 if(!scse.getLeftDesc().trim().equals("") && !scse.getRigtDesc().trim().equals("")) {
			    				    	...
			    				    	if(!scse.getBottemDesc().equals("")) {
			    							...
			    							// botemtable.setWidthPercentage(95);
			    							 ...
			    							 //ItemNames
			    							 PdfPTable botemtable2 = new PdfPTable(2);
			    							 cell = new PdfPCell(new Phrase(scse.getName(), regular));
				    						 cell.setBorderColor(BaseColor.RED);
				    						 cell.setColspan(2);
				    						 botemtable2.addCell(cell);
			    							 document.add(botemtable2);
			    						 }
			    	...
			    	//		}
		    		 ...
		    		 PdfPTable table1 = new PdfPTable(colNo);
		 	    	 ...
		 	    	 //data Population
		    			// List<CrfGroupElementData> scgdataList = null;
		    			 	...
		    			 	if(dataMap.size() !=0) {
		    			 			for(int i=1; i<=rowCount; i++) {
				    			    	for(int s=0; s<group.getMaxColumns(); s++) {
	    				    				...
	    				    				//for(CrfGroupElement scg : group.getElement()) {
	    		    			 				if(pos.size() !=0) {
	    		    			 					if(pos.contains((s))) {
	    		    			 						int po =0;
