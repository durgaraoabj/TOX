...
@Component
public class PdfGeneratingAction extends PdfPageEventHelper {
	
	
	@SuppressWarnings({ "deprecation", "unlikely-arg-type" })
	public void generatePdf(HttpServletResponse response, HttpServletRequest request, Crf crf, VolunteerPeriodCrf vpc, CrfPdfService crfPdfService, CrfDAO crfDAO) throws DocumentException, IOException {
