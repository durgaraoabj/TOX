...
@Entity
@Table(name = "CRF_SECTION_ELEMENT_WeightData")
public class CrfSectionElementWeightData  extends CommonMaster implements Serializable{
	
	@Id
	@SequenceGenerator(name="pk_sequence",sequenceName="CrfSectionElementWeightData_id_seq", allocationSize=1)
