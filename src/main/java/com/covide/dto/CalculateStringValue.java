...
public class CalculateStringValue {
	
	/*public static void main(String[] args) {
		double value = getCalculateStringValue("(1 + 1) + 3 * (2 + 5)");
		System.out.println("value is : "+(int)Math.round(value));
	}
*/
    static public int getCalculateStringValue(String calculateString) {
    	double value = calculateInversePolandExpression(getInversePolandExpression(calculateString));
