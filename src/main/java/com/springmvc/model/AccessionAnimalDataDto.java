...
public class AccessionAnimalDataDto extends CommonMaster implements Serializable {
	...
	private Map<Long, StudyAccessionCrfSectionElementData> elementData = new HashMap<>();
	@Transient
	...
	public Map<Long, StudyAccessionCrfSectionElementData> getElementData() {
		return elementData;
	}
	public void setElementData(Map<Long, StudyAccessionCrfSectionElementData> elementData) {
