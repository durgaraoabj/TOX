...
@Entity
@Table(name="Randomization")
public class Randomization extends CommonMaster implements Serializable {
	
	@Id
	@SequenceGenerator(name="pk_sequence",sequenceName="Randomization_id_seq", allocationSize=1)
...
//	@ManyToOne
	...
	private String status = "REQUESTED"; //REQUESTED or AVILABLE
