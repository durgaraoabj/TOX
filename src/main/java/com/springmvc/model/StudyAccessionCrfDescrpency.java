...
@Entity
@Table(name="study_accession_crf_descrpency")
public class StudyAccessionCrfDescrpency extends CommonMaster implements Serializable {
	
	
	@Id
	@SequenceGenerator(name="pk_sequence",sequenceName="StudyAccessionCrfDescrpency_id_seq", allocationSize=1)
